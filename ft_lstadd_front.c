...
// Звёздочка нужна только когда хочешь залезть внутрь узла. А сам узел целиком — просто new.

// а если внутрь то это слово "hello"

// Да, именно. *new — это содержимое узла целиком, а new->content — это уже конкретно "hello".
